    ...
    <div class="col-sm-8">
        <ul class="nav nav-pills nav-justified">
            <li role="presentation"><a href="message_inbox.php">Inbox <span
                            class="badge"><?php echo ($newMessages = check_new_mail_friends($current_userid) + check_new_mail_circles($current_userid) ) ?></span></a></li>
            ...
            <table class="col-md-10">
                <form name="form_message" method="post" action="messages.php">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" id="title" name="title" value="<?php echo $message_title?>"
                    ...
                    <tr>
                        ...
                        <td><textarea class="form-control" contenteditable="true" id="message_content_field" rows="5" style="width: 100%" aria-describedby="message_helper"
                                      name="message_content" value="<?php echo $message_content?>"></textarea>
