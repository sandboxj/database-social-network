...
$message_title = "";
$message_content = "";
$result1 = search_circles();
$result2 = search_recipient();
            ...
            <table class="col-md-10">
                <form name="form_message" method="post" action="messages.php">
                    ...
                    <tr>
                        ...
                        <td><textarea class="form-control" id="message_content_field" rows="5" style="width: 100%" aria-describedby="message_helper"
