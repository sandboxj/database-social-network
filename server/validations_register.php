...
<?php
    if(isset($_POST["register"])) {
        ...
        $fields_required = array("username", "password", "first_name", "last_name", "date_of_birth");
        ...
        if (empty($errors)) {
            ...
            // Insert
            $query = "INSERT INTO User (UserID, Password, FirstName, LastName, Dob)";
            $query .= " VALUES ('{$username}', '{$hashed_password}', '{$first_name}', '{$last_name}', '{$date_of_birth}')";
